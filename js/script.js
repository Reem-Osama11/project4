...
const product1=new products('Watch','80 $','accessories','images/photo-1617043786394-f977fa12eddf.avif',1);

const product2=new products('Watch','80 $','accessories','images/photo-1617043983671-adaadcaa2460.avif',2);

const product3=new products('earpods','200 $','Phone accessories ','images/pexels-photo-3394665.jpeg',3);

const product4=new products('earpods','200 $','Phone accessories ','images/pexels-photo-7772547.webp',4);



const product5=new products('Phones','80 $','Phones','images//pexels-photo-3934704.jpeg',5);


const product6=new products('Laptop','20 $','Electronic Device','images/pexels-photo-943596.webp',6);

const product7=new products('Phones','80 $','Phones','images///photo-1589492477829-5e65395b66cc (1).webp',7);



const product8=new products('Play station','80 $','Games','images/pexels-photo-7831752.webp',8);


const product9=new products('Play station','80 $','Games','images//pexels-photo-3945657.webp',9);
